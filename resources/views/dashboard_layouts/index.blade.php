        ...
        <nav class="navbar header-navbar pcoded-header">
            <div class="navbar-wrapper">
                ...
                <div class="navbar-logo">
                    ...
                    <a href="index-1.htm">
                        {{-- <img class="img-fluid" src="{!! url('img/wallet.jpeg') !!}" width="50" height="50" > --}}
                        @if (Auth::check())
Welcome
                        {{auth()->user()->name}}
                ...
                <nav class="pcoded-navbar">
                    <d class="pcoded-inner-navbar main-menu">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li>
                                <a href="/Dashboard/Student/Show">
                                <span class="pcoded-micon"><i class="feather icon-home"></i></span>
                               <span>   <i class="fas fa-tachometer-alt"></i> </span>Manage Students</a>
                            </li>
                            <li>
                                <a href="/Dashboard/Professor/Show">
                                <span class="pcoded-micon"><i class="feather icon-home"></i></span>
                               <span>   <i class="fas fa-tachometer-alt"></i> </span>Manage Professors</a>
                            </li>
                            <li>
                                <a href="/Dashboard/Admin/Show">
                                <span class="pcoded-micon"><i class="feather icon-home"></i></span>
                               <span>   <i class="fas fa-tachometer-alt"></i> </span>Manage Admins</a>
                            </li>
                            <li>
                                <a href="/Dashboard/User/Show">
                                <span class="pcoded-micon"><i class="feather icon-home"></i></span>
                               <span>   <i class="fas fa-tachometer-alt"></i> </span>Manage Users</a>
                            </li>
                            <li>
                                <a href="/Dashboard/File/Show">
                                <span class="pcoded-micon"><i class="feather icon-home"></i></span>
                               <span>   <i class="fas fa-tachometer-alt"></i> </span>Manage Files</a>
                            </li>
                            <li>
                                <a href="/Dashboard/Contact/Show">
                                <span class="pcoded-micon"><i class="feather icon-home"></i></span>
                               <span>   <i class="fas fa-tachometer-alt"></i> </span>Manage Contact</a>
                            </li>
                            <li>
                                <a href="/">
                                <span class="pcoded-micon"><i class="feather icon-home"></i></span>
                               <span>   <i class="fas fa-tachometer-alt"></i> </span>Home</a>
                            </li>
                        </ul>
