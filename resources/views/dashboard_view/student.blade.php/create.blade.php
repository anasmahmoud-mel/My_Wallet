                      ...
                      <div class="col-lg-4">
                          <div class="page-header-breadcrumb">
                              <ul class="breadcrumb-title">
                                  ...
                                  <li class="breadcrumb-item"><a href="/Dashboard/Professor/Show">Professor Table</a>
                                  </li>
                                  <li class="breadcrumb-item"><a href="/Dashboard/Professor/Create">Create New </a>
                                  </li>
                              </ul>
                          </div>
                      </div>
                          ...
                          <div class="col-sm-12">
                              ...
                              <div class="card">
                                  ...
                                  <div class="card-block">
                                    <form method="post" action="/Dashboard/Professor/Create">
                                      {{csrf_field()}}
